...
<div id="document" class="mb-4">
   ...
   <div class="tab-content">
      <div class="tab-pane fade show active" id="document-hot" role="tabpanel">
         <div class="row mx-n2">
            @foreach($best_downloads as $post)
         ...
         <div id="btn-show-more" class="mt-3">
            <a href="{{ route('document', ['download' => 'desc']) }}" class="btn-show-more">Show more <i class="ti-arrow-right ti-show-more"></i></a>
         </div>
      </div>
      <div class="tab-pane fade" id="document-new" role="tabpanel">
         ...
         <div id="btn-show-more" class="mt-3">
            <a href="{{ route('document', ['sort' => 'id__asc']) }}" class="btn-show-more">Show more <i class="ti-arrow-right ti-show-more"></i></a>
         </div>
      </div>
      <div class="tab-pane fade" id="document-related" role="tabpanel">
         ...
         <div id="btn-show-more" class="mt-3">
            <a href="{{ route('document', ['sort' => 'view__asc']) }}" class="btn-show-more">Show more <i class="ti-arrow-right ti-show-more"></i></a>
         </div>
      </div>
   </div>
