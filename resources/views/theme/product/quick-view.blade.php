    ...
    <div class="product-single">
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                @include($templatePath .'.product.product-gallery', compact('galleries','product'))
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12 col-12">
...
<!--End Quick View popup-->
    ...
    <script src="{{ asset($templateFile .'/plugins/photoswipe.min.js') }}"></script>
    <script src="{{ asset($templateFile .'/plugins/photoswipe-ui-default.min.js') }}"></script>
    <script>
        $(function() {
            var $pswp = $('.pswp')[0],
                image = [],
