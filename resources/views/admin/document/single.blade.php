        ...
        <form action="{{ $url_action }}" method="POST" id="frm-create-post" enctype="multipart/form-data">
    	    ...
    	    <div class="row">
    	      	<div class="col-9">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="price" id="price" value="{{ number_format($price ?? 0) }}" class="form-control">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="promotion" class="title_txt">Giá khuyến mãi</label>
                                        <input type="number" name="promotion" id="promotion" value="{{ number_format($promotion ?? 0) }}" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                    ...
                    @include('admin.partials.image', ['no_thumb'=> 1,'title'=>'File tài liệu', 'id'=>'file_view', 'name'=>'file', 'image'=> ($file ?? '')])
