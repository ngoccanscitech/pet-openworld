	        	...
	        	<div class="card">
		          	...
		          	<div class="card-body">
                        <div class="clear">
                            <ul class="nav fl">
                                <li class="nav-item">
                                    <a class="btn btn-danger" onclick="delete_id('investor')" href="javascript:void(0)"><i class="fas fa-trash"></i> Delete</a>
                                </li>
                                <li class="nav-item">
                            ...
                            <table class="table table-bordered" id="table_index">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="">
                                            <a class="row-title" href="{{route('admin_investor.edit', $data->id)}}">
                                                <b>{{$data->name}}</b>
                                                <br>
