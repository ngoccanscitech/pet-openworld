...
Route::localized(function () {
    ...
    Route::get('/dang-ky-thanh-cong', 'Auth\RegisterController@registerSuccess')->name('register_success');

    Route::group(['prefix' => 'customer'], function() {
        Route::post('/logout', 'Customer\CustomerLoginController@logout')->name('logout');
    });

    //user forget password
    Route::group(['prefix' => 'forget'], function() {
        //user forget password
        Route::get('password', 'CustomerController@forgetPassword')->name('forgetPassword');
        Route::post('password', 'CustomerController@actionForgetPassword')->name('actionForgetPassword');

        Route::get('password-step-2', 'CustomerController@forgetPassword_step2')->name('forgetPassword_step2');
        Route::post('password-step-2', 'CustomerController@actionForgetPassword_step2')->name('actionForgetPassword_step2');

        Route::get('password-step-3', 'CustomerController@forgetPassword_step3')->name('forgetPassword_step3');
        Route::post('password-step-3', 'CustomerController@actionForgetPassword_step3')->name('actionForgetPassword_step3');
    });
    ...
    Route::group(['middleware' => 'auth'], function () {
        ...
        Route::group(['prefix' => 'customer'], function() {
            ...
            Route::post('/nap-tai-khoan', 'PaymentController@checkout')->name('recharge');

            Route::post('/register-author', 'CustomerController@updateAuthor')->name('register_author');
            ...
            Route::get('/payment-history', array('as' => 'payment_history', 'uses' => 'PaymentController@paymentHistory'));
        ...
        Route::get('khai-thac-tai-lieu-tra-phi', 'DocumentController@upload')->name('document_upload');
        Route::post('khai-thac-tai-lieu-tra-phi', 'DocumentController@postUpload');
        // Route::get('dang-tai-lieu-thanh-cong', 'DocumentController@postUploadSuccess')->name('document_upload.success');
        Route::post('download-comfirm', 'DocumentController@download')->name('download.comfirm');
    });
    ...
    Route::group(['prefix' => 'wishlist'], function() {
        Route::get('/', 'WishlistController@wishlist')->name('wishlist');
        Route::post('/add', 'WishlistController@addWishlist')->name('wishlist_add');
    });
    ...
    //research
    //research
    Route::group(['prefix' => 'nghien-cuu'], function() {
        Route::get('/', 'ResearchController@index')->name('research');
        Route::get('{slug}', 'ResearchController@categoryDetail')->name('research.detail');
    });
    //research
    Route::group(['prefix' => 'tai-lieu'], function() {
        Route::get('/', 'DocumentController@index')->name('document');
        Route::get('{slug}', 'DocumentController@detail')->name('document.detail');
    });
