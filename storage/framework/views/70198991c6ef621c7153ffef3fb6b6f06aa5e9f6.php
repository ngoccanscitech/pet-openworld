                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="list_category">
                                <?php
                                    $id = $id ?? 0;
                                    $data_checks = App\Model\ResearchCategoryJoin::where('research_id', $id)->get();
                                    $array_checked = array();
                                    if($data_checks){
                                    ...
                                    $categories = App\Model\ResearchCategory::where('status', 1)->orderByDESC('sort')->get();
                                ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/domains/exproweb.com/public_html/thuvientonghop/resources/views/admin/research/single.blade.php ENDPATH**/ ?>