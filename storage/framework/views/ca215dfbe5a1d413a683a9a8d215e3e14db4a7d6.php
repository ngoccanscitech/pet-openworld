    ...
    <div class="product-single">
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                <?php echo $__env->make($templatePath .'.product.product-gallery', compact('galleries','product'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12 col-12">
...
<!--End Quick View popup-->
    ...
    <script src="<?php echo e(asset($templateFile .'/plugins/photoswipe.min.js')); ?>"></script>
    <script src="<?php echo e(asset($templateFile .'/plugins/photoswipe-ui-default.min.js')); ?>"></script>
    <script>
        $(function() {
            var $pswp = $('.pswp')[0],
                image = [],
...
<?php /**PATH /home/admin/domains/exproweb.com/public_html/thuvientonghop/resources/views/theme/product/quick-view.blade.php ENDPATH**/ ?>