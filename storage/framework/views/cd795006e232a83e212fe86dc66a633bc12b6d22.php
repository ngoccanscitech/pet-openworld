...
<div class="container">
    <div class="product-single mt-lg-3">
        <div class="row">
            <div class="col-lg-5 col-md-6 col-sm-12 col-12 mt-lg-0 mt-3">
...
<?php echo $__env->make($templatePath .'.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/domains/exproweb.com/public_html/thuvientonghop/resources/views/theme/product/product-single.blade.php ENDPATH**/ ?>