<div class="product-single__meta mt-lg-0 mt-3">
   ...
   <?php if($product->sku): ?>
      <div class="prInfoRow mb-3 d-flex flex-wrap">
         ...
         <div class="product-element"><a href="<?php echo e(route('shop', ['element' => $element])); ?>">Sản phẩm cùng thành phần</a></div>
         <?php endif; ?>
      </div>
   <?php endif; ?>
...
</div><?php /**PATH /home/admin/domains/exproweb.com/public_html/thuvientonghop/resources/views/theme/product/product-summary.blade.php ENDPATH**/ ?>