...
<div id="page-content" class="page-template page-checkout">
    <div class="container pt-4 pb-3 py-sm-4">
        ...
        <form action="<?php echo e(route('cart_checkout.process')); ?>" method="post" id="form-checkout">
            ...
            <input type="hidden" name="cart_total" value="<?php echo e($total + $data_shipping['shipping_cost']); ?>" data-origin="<?php echo e($total); ?>">
...
<?php echo $__env->make($templatePath .'.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/domains/exproweb.com/public_html/thuvientonghop/resources/views/theme/cart/quick-buy-confirm.blade.php ENDPATH**/ ?>