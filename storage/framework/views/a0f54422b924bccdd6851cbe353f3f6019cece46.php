<ul class="list-group mb-3">
    <li class="list-group-item">
        <div class="form-check">
          <input class="form-check-input" type="radio" id="delivery_ship" name="delivery" value="shipping" checked>
          <label class="form-check-label" for="delivery_ship">Giao hàng nhanh</label>
          <div class="ship-content mt-2" style="display: none;">
    ...
    <li class="list-group-item">
        <div class="form-check">
          <input class="form-check-input" type="radio" id="delivery_pickup" name="delivery" value="pick_up">
          <label class="form-check-label" for="delivery_pickup"><?php echo app('translator')->get('Pick up'); ?></label>
        </div>
...
</div><?php /**PATH /home/admin/domains/exproweb.com/public_html/thuvientonghop/resources/views/theme/cart/includes/cart-shipping.blade.php ENDPATH**/ ?>