<div class="register-form position-relative">
    ...
    <form action="" id="customer-register" method="POST">
        ...
        <button type="button" class="btn btn-primary w-100 mb-3 btn-register"><?php echo e(__('register')); ?></button>
    </form>
    <div class="social-login-box text-center mt-3">
        <hr style="opacity: 0.3">
        <p class="small text-center"><em><?php echo e(__('social-login')); ?></em></p>
...
</div><?php /**PATH /home/admin/domains/exproweb.com/public_html/thuvientonghop/resources/views/auth/registration-form.blade.php ENDPATH**/ ?>