<div class="offcanvas offcanvas-collapse" id="vendor-sidebar">
   ...
   <div class="offcanvas-body">
      ...
      <div class="vendor-img d-lg-none d-block mb-4">
      	<img src="<?php echo e($user->avatar??'/upload/images/general/author.png'); ?>" width="140" alt="Avatar">
      </div>
      <!-- User meta-->
      <div class="pb-2">
         <h3 class="mb-2 fs-lg fw-normal text-body"><?php echo e($user->fullname); ?></h3>
   ...
   <div class="offcanvas-footer d-flex flex-column align-items-start p-lg-0">
      ...
      <div class="mb-4 pb-2 fs-sm">
         ...
         <div class="mb-0"><?php echo htmlspecialchars_decode($user->about_me); ?></p>
      </div>
      <!-- Socials-->
...
</div><?php /**PATH /home/admin/domains/exproweb.com/public_html/thuvientonghop/resources/views/theme/author/sidebar.blade.php ENDPATH**/ ?>