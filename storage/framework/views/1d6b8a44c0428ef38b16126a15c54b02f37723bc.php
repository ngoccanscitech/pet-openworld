	        	...
	        	<div class="card">
		          	...
		          	<div class="card-body">
                        <div class="clear">
                            <ul class="nav fl">
                                <li class="nav-item">
                                    <a class="btn btn-danger" onclick="delete_id('review')" href="javascript:void(0)"><i class="fas fa-trash"></i> Delete</a>
                                </li>
                                <li class="nav-item">
                            ...
                            <table class="table table-bordered" id="table_index">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="">
                                            <a class="row-title" href="<?php echo e(route('admin_review.edit', $data->id)); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/domains/exproweb.com/public_html/thuvientonghop/resources/views/admin/review/index.blade.php ENDPATH**/ ?>