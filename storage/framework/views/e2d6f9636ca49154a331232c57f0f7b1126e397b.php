  ...
  <div class="container">
    <div class="row">
        <div class="col-lg-9">
          <div class="blog-detail">
            <div class="blog-post">
              ...
              <div class="mt-3">
                ...
                <a class="btn-social bs-facebook me-2 mb-2" href="https://www.facebook.com/sharer/sharer.php?u=<?php echo e(url()->current()); ?>&amp;t=<?php echo e($news->title); ?>"><i class="ci-facebook"></i></a>
          ...
          <h6 class="text-primary mt-4"><?php echo app('translator')->get('Tin tức liên quan'); ?></h6>
          <ul class="pl-3">
            <?php if(count($news_featured)>0): ?>
              ...
              <li>
                <a class="text-dark" href="<?php echo e(route('news.single', ['id' => $item->id, 'slug' => $item->slug], true, $lc)); ?>"><?php echo e($item->name); ?></a>
              </li>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make($templatePath .'.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/domains/exproweb.com/public_html/thuvientonghop/resources/views/theme/news/single.blade.php ENDPATH**/ ?>