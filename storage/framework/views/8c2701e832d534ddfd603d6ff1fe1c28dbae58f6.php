...
<?php else: ?>
    ...
    <option value="<?php echo e($item->id); ?>" <?php echo e($parent == $item->id ? 'selected' : ''); ?> ><?php echo $slit; ?><?php echo e($item->name); ?></option>
        ...
        <?php endif; ?>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php endif; ?><?php /**PATH /home/admin/domains/exproweb.com/public_html/thuvientonghop/resources/views/admin/product-category/includes/select-category.blade.php ENDPATH**/ ?>