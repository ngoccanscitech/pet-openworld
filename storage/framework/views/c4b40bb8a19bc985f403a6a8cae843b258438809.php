<footer>
            ...
            <div class="row pt-34">
                ...
                <div id="register" class="col-lg-4 col-md-6 col-sm-12">
                    ...
                    <div class="form-register-email">
                        <form action="<?php echo e(route('subscription')); ?>" class="my-2">
    ...
    <?php echo $__env->make($templatePath .'.parts.notify', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

</footer><?php /**PATH /home/admin/domains/exproweb.com/public_html/thuvientonghop/resources/views/theme/layouts/footer.blade.php ENDPATH**/ ?>