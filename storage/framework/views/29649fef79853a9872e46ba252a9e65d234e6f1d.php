    ...
    <ul class="list-group my-3 shop-address-list">
        <li class="list-group-item">
            <div class="form-check">
              ...
              <label class="form-check-label" for="shop_address"><div><?php echo htmlspecialchars_decode(setting_option('pickup_address')); ?></div></label>
            </div>
        </li>
    </ul>
</div>
...
</fieldset><?php /**PATH /home/admin/domains/exproweb.com/public_html/thuvientonghop/resources/views/theme/cart/includes/customer-info.blade.php ENDPATH**/ ?>