    	        	...
    	        	<div class="card">
    		          	...
    		          	<div class="card-body">
                            ...
                            <!-- <div class="form-group">
                                ...
                                <input id="template_checkID" type="checkbox" name="template" value="1" <?php if($template == 1): ?> checked <?php endif; ?>>
                            </div>
                            <div class="form-group">
                                <label for="show_footer" style="color: #FF0000;">Hiện thị Footer</label>
                                <input id="show_footer" type="checkbox" name="show_footer" value="1" <?php if($show_footer == 1): ?> checked <?php endif; ?>>
                            </div> -->
    		        	</div> <!-- /.card-body -->
    	      		</div><!-- /.card -->
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/domains/exproweb.com/public_html/thuvientonghop/resources/views/admin/page/single.blade.php ENDPATH**/ ?>